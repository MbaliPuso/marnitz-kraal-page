  ...
  <div className="container" data-aos="fade-up">
    ...
    <div className="row menu-container" data-aos="fade-up" data-aos-delay={200}>
      <div className="col-lg-6 menu-item filter-starters">
        <img src="assets/img/menu/lobster-bisque.jpg" className="menu-img" alt='lobster nisque' />
      ...
      <div className="col-lg-6 menu-item filter-starters">
        <img src="assets/img/menu/cake.jpg" className="menu-img" alt='cake' />
        <div className="menu-content">
      ...
      <div className="col-lg-6 menu-item filter-salads">
        <img src="assets/img/menu/caesar.jpg" className="menu-img" alt='caeser salad' />
        <div className="menu-content">
      ...
      <div className="col-lg-6 menu-item filter-starters">
        <img src="assets/img/menu/mozzarella.jpg" className="menu-img" alt='mozzarella' />
        <div className="menu-content">
